...
BaseFacebook.prototype.restserver = function restserver(params, callback) {
  ...
  this.oauthRequest(host, '/restserver.php', params, method, cb.returnToCallback(callback, false, function(result) {
...
BaseFacebook.prototype.graph = function graph(/* path, method, params, callback */) {
  ...
  var self = this;
  this.oauthRequest(domain, path, params, method, cb.returnToCallback(callback, false, function(result) {
