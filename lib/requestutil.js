...
exports.requestFacebookApi = function(host, path, params, callback) {
  var req = new FacebookApiRequest(host, path, params);
  req.start(callback);
};
...
function FacebookApiRequest(host, path, params) {
